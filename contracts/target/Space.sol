...
contract Space is ISpace, Initializable, IERC4824, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    // @inheritdoc ISpaceState
    // mapping(uint256 proposalId => mapping(uint8 choice => euint32 votePower)) private votePower;       // choice made public  @inco
    /// @inheritdoc ISpaceState
    ...
    function vote(              // @inco
        ...
        targetEndpoint.vote(proposalId, choice, votingPower);
        //method 1
    ...
    /// @inheritdoc ISpaceActions
    function execute(uint256 proposalId, bytes calldata executionPayload) external override nonReentrant {      //@votePower @inco
    ...
    function _getCumulativePower(//@votePower
        address userAddress,
        uint32 blockNumber,
